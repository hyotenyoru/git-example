...
def imagemap_message():
    message = ImagemapSendMessage(
        base_url="https://drive.google.com/file/d/17r04smoB-Q0e5b0XL-7M0L2VUBLQki-R/view?usp=sharing",
        alt_text='刀劍神域',
        base_size=BaseSize(height=4000, width=2000),
        actions=[
            URIImagemapAction(
                #刀劍神域 Sword Art Online
                link_uri="https://ani.gamer.com.tw/animeVideo.php?sn=926",
                area=ImagemapArea(
                    x=0, y=0, width=1000, height=1000
                )
            ),
            URIImagemapAction(
                #刀劍神域 Sword Art Online 第二季
                link_uri="https://ani.gamer.com.tw/animeVideo.php?sn=903",
                area=ImagemapArea(
            ...
            URIImagemapAction(
                #刀劍神域 劇場版 序列爭戰
                link_uri="https://ani.gamer.com.tw/animeVideo.php?sn=9242",
                area=ImagemapArea(
            ...
            URIImagemapAction(
                ...
                link_uri="https://ani.gamer.com.tw/animeVideo.php?sn=9684",
                area=ImagemapArea(
            ...
            URIImagemapAction(
                #刀劍神域 Alicization 
                link_uri="https://ani.gamer.com.tw/animeVideo.php?sn=10849",
                area=ImagemapArea(
                    x=0, y=2000, width=1000, height=1000
                )
            ),URIImagemapAction(
                #刀劍神域 Alicization War of Underworld
                link_uri="https://ani.gamer.com.tw/animeVideo.php?sn=13805",
                area=ImagemapArea(
                    x=1000, y=2000, width=1000, height=1000
                )
            ),URIImagemapAction(
                #刀劍神域 Alicization War of Underworld -THE LAST SEASON
                link_uri="https://ani.gamer.com.tw/animeVideo.php?sn=16243",
                area=ImagemapArea(
                    x=0, y=3000, width=1000, height=1000
                )
            )
